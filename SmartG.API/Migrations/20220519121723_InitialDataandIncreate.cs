...
{
    public partial class InitialDataandIncreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContentBlocks_Portfolios_PortfolioId",
                        column: x => x.PortfolioId,
                        principalTable: "Portfolios",
                        principalColumn: "PortfolioId");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "The innner part of the solar cookker is made of mirroes", new DateTime(2022, 5, 19, 14, 17, 23, 660, DateTimeKind.Local).AddTicks(6590), new DateTime(2022, 5, 19, 14, 17, 23, 660, DateTimeKind.Local).AddTicks(6590), false, null, "The inner was the inner", "test,tets,done", "home", "Home" },
                    { 2, null, "The innner part of the solar cookker is made of mirroes", new DateTime(2022, 5, 19, 14, 17, 23, 660, DateTimeKind.Local).AddTicks(6600), new DateTime(2022, 5, 19, 14, 17, 23, 660, DateTimeKind.Local).AddTicks(6600), false, null, "The inner was the inner", "test,tets,done", "about", "About" },
                    { 3, null, "The innner part of the solar cookker is made of mirroes", new DateTime(2022, 5, 19, 14, 17, 23, 660, DateTimeKind.Local).AddTicks(6600), new DateTime(2022, 5, 19, 14, 17, 23, 660, DateTimeKind.Local).AddTicks(6600), false, null, "The inner was the inner", "test,tets,done", "contact", "Contact" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentBlocks_PortfolioId",
                table: "ContentBlocks",
                column: "PortfolioId");
