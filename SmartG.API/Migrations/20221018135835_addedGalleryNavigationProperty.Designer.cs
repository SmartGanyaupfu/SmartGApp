...
namespace SmartG.API.Migrations
{
    ...
    [Migration("20221018135835_addedGalleryNavigationProperty")]
    partial class addedGalleryNavigationProperty
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a6cfbed4-dac9-451b-a76f-3323eda0858a",
                            ConcurrencyStamp = "70051e1d-690d-4eaf-97bb-913b22ecdbbf",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "b5177d9b-af7f-4426-a4e3-e672ce3b94f8",
                            ConcurrencyStamp = "475823e2-ca6d-4221-8e52-860564f37a2c",
                            Name = "Subscriber",
                            NormalizedName = "SUBSCRIBER"
                        },
                        new
                        {
                            Id = "19a895b0-4c66-4acb-8efb-152251dc0b35",
                            ConcurrencyStamp = "00616288-8804-456a-b17f-fbf25201c6c6",
                            Name = "Editor",
            ...
            modelBuilder.Entity("SmartG.Entities.Models.Page", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2022, 10, 18, 15, 58, 35, 93, DateTimeKind.Local).AddTicks(6030),
                            DateUpdated = new DateTime(2022, 10, 18, 15, 58, 35, 93, DateTimeKind.Local).AddTicks(6030),
                            Deleted = false,
                        ...
                        new
                        {
                            PageId = 2,
                            Content = "The innner part of the solar cookker is made of mirroes",
                            DateCreated = new DateTime(2022, 10, 18, 15, 58, 35, 93, DateTimeKind.Local).AddTicks(6040),
                            DateUpdated = new DateTime(2022, 10, 18, 15, 58, 35, 93, DateTimeKind.Local).AddTicks(6040),
                            Deleted = false,
                            MetaDescription = "The inner was the inner",
                            MetaKeyWords = "test,tets,done",
                            Slug = "about",
                        ...
                        new
                        {
                            PageId = 3,
                            Content = "The innner part of the solar cookker is made of mirroes",
                            DateCreated = new DateTime(2022, 10, 18, 15, 58, 35, 93, DateTimeKind.Local).AddTicks(6050),
                            DateUpdated = new DateTime(2022, 10, 18, 15, 58, 35, 93, DateTimeKind.Local).AddTicks(6050),
                            Deleted = false,
                            MetaDescription = "The inner was the inner",
                            MetaKeyWords = "test,tets,done",
                            Slug = "contact",
            ...
            modelBuilder.Entity("SmartG.Entities.Models.OfferedService", b =>
                {
                    b.HasOne("SmartG.Entities.Models.Gallery", "Gallery")
                        .WithMany()
                        .HasForeignKey("GalleryId");
